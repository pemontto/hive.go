...
import (
	"github.com/pemontto/hive.go/filter"
	"testing"
)
...
func setupFilter(filterSize int, byteArraySize int) (*filter.ByteArrayFilter, []byte) {
	filter := filter.NewByteArrayFilter(filterSize)
